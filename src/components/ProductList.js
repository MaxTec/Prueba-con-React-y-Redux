  ...
  render() {
    return (
      <div style={styles.products}>
        {/* con este map  recorremos el arreglo y guardamos todo el product 
        que depues pasamos a la funcion addtocart() para  pasarlo como
        paranetro al dispatch que se lo pasara  la fucnion reductora.
        */}
